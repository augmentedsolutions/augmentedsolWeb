...
const ClientHome = () => {
  return (
    <>
      ...
      <div className="row background_gradient_one   p-1 p-md-3 p-lg-5 border_radius_one" style={{position:'relative',height:'490px',border: "3.24px solid rgb(47, 20, 63)",marginBottom:'120px'}}>
